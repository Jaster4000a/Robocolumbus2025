...
def generate_launch_description():
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/rover/Desktop/Robocolumbus2025/colombus_ws/robot_config/'
                )
                ,
                (
                    'use_sim_time'
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                ...
                ,
                '/model/rover/robot/cmd_vel@geometry_msgs/msg/Twist]ignition.msgs.Twist'
                ,
            ]
        ,
        remappings=
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/rover/robot/tf@tf2_msgs/msg/TFMessage[ignition.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
